...
export default function CustomerProfile() {
  ...
  useEffect(() => {
    const activeUser = authUser ? { name: `${authUser.firstName} ${authUser.lastName}`, email: authUser.email, phone: authUser.phone || '', company: authUser.companyName || '', avatar: '' } : null;
    if (activeUser) {
      setUser({
    ...
    // Fetch notifications from real API when ready
  }, []);
