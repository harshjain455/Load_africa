...
import { ArrowLeft, User, Phone, Mail, Activity, Calendar, Truck, FileText, CreditCard, RefreshCcw, Building } from 'lucide-react';
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64 text-slate-500">
        <RefreshCcw className="h-6 w-6 animate-spin mr-2" /> Loading fleet details...
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">Fleet Details</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            {user.fleet_owner && (
              <div>
                <h3 className="text-sm font-bold text-slate-900 mb-4 flex items-center gap-2">
                  <Building className="h-4 w-4 text-slate-400" /> Fleet Information
                </h3>
                <div className="p-4 bg-slate-50 rounded-xl space-y-2">
